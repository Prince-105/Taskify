...
* 📂 Organize tasks into four sections:
  ...
  * ⚙️ On Process
  * 🎉 Completed
* 🔄 Drag and drop tasks between sections based on progress
* 🗑️ Drag a task upward to instantly delete it
* 📅 Assign Start Date and End Date to tasks
* ⏱️ Built-in Stopwatch to track work sessions
* 📝 Notes section for reminders and quick ideas
* 💾 Local Storage support to preserve data after page refresh
